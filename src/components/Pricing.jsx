...
function Pricing() {
  ...
  <div className="container px-5 py-24 mx-auto" bis_skin_checked="1">
    <div className="flex flex-col text-center w-full mb-20" bis_skin_checked="1">
      <h1 className="sm:text-4xl text-3xl  title-font mb-2 text-gray-900 font-bold ">Pricing</h1>
    ...
    <div className="lg:w-2/3 w-full mx-auto overflow-auto" bis_skin_checked="1">
      <table className="table-auto w-full text-left whitespace-no-wrap">
        ...
        <tbody>
          <tr>
            ...
            <td className="px-4 py-3 text-lg text-gray-900 font-thin">Free</td>
    ...
    <div className="flex pl-4 mt-4 lg:w-2/3 w-full mx-auto" bis_skin_checked="1">
      <a className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
          <path d="M5 12h14M12 5l7 7-7 7"></path>
        </svg>
      </a>
      <button className="flex ml-auto text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800  ">Submit</button>
    </div>
  </div>
</section>
  )
